...
export type IMutation = {
  __typename?: 'Mutation';
  doSomething: Scalars['String']['output'];
};

export type IMyReturnType = {
  __typename?: 'MyReturnType';
...
export type IQuery = {
  __typename?: 'Query';
  getThing: IMyReturnType;
  getThing2: IMyReturnType;
};
...
export type ISubscriptionGreetingsArgs = {
...
export type IResolversTypes = {
  ...
  MyReturnType: ResolverTypeWrapper<Partial<IMyReturnType>>;
...
export type IResolversParentTypes = {
  ...
  Mutation: {};
  MyReturnType: Partial<IMyReturnType>;
  Query: {};
...
> = {
  greetings?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ISubscriptionGreetingsArgs, 'type'>
  >;
};
...
export type IResolvers<ContextType = any> = {
  ...
  MyReturnType?: IMyReturnTypeResolvers<ContextType>;
